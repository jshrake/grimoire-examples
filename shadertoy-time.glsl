...
// Original source: https://www.shadertoy.com/view/lsXGz8
...
// NOTE(jshrake): We need to condition this shader on #define GRIM_FRAGMENT as it uses
// fwidth which is only available when compiling the fragment shader.
#ifdef GRIM_FRAGMENT
